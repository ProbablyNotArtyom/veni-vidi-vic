; The last demopart by Marko M�kel�
...
; Jonas Hult�n <md6cbm@mdstud.chalmers.se> refused to release the source code
...
;; cut -c3-|tr @A-Z���fs����\\012 '\0-\037\044-\046\042 ' \
...
; The 2nd scrolltext.
;;;
; DET VAR ALLT VI HAR. VI �VERG�R TILL H�LSNINGARNA, SOM G�R TILL ALLA
; VIC20-ANV�NDARE, SPECIELLT PAUL LE BRASSE OCH WARD SHRAKE, SOM HAR
; ARKIVERAT MASSOR AV VIC20-CARTRIDGES, OCH TILL MIGUEL GORDILLO, SOM
; HJ�LPTE OSS ATT M�TA SK�RMSTORLEKEN P� 6560. VI H�LSAR OCKS� TILL
; DANIEL DALLMANN, SOM DONERADE SIN NTSC VIC-20 TILL OSS. SIST MEN
; INTE MINST, VILL VI TACKA RICHARD STALLMAN OCH LINUS TORVALDS F�R
; OPERATIVSYSTEMET VI ANV�NDE SOM UTVECKLINGSMILJ� F�R
; DEMOT. F�RRESTEN, VISSTE NI ATT LINUS B�RJADE SIN DATORKARRI�R P�
; VIC-20?
;;;
...
; The 3rd scrolltext.
;;;
; T�SS� T�M� DEMO NYT SITTEN OLI. SAAKO L�HETT�� TERVEISI�? NO, JOS
; NYT T�M�N KERRAN. TERVEHDIMME KAIKKIA VIC-20:N K�YTT�JI�, ERITOTEN
; PAUL LE BRASSEA JA WARD SHRAKEA, JOTKA KER�SIV�T TALTEEN
; MODUULIPELEJ� URAKALLA. NTSC-MUUNNOS OLISI J��NYT TEKEM�TT�, ELLEI
; DANIEL DALLMANN OLISI LAHJOITTANUT KONETTAAN. LIS�KSI MIGUEL
; GORDILLOSTA OLI SUURI APU NTSC-KUVAN KOON MITTAAMISESSA. LOPUKSI
; HALUAMME KIITT�� RICHARD STALLMANIA JA LINUS TORVALDSIA DEMON
; KEHITYSYMP�RIST�N RUNGOSTA. TIESITTEK� MUUTEN, ETT� LINUS ALOITTI
...
; The 4th scrolltext.
;;;
; DAS WAR ALLES, UND ES IST DIE ZEIT F�R BEGR�SSUNGEN. WIR BEGR�SSEN
...
; UND MIGUEL GORDILLO, DER UNS BEI DER VERMESSUNG VON NTSC-BILDGR�SSE
; GEHOLFEN HAT. ZUM SCHLUSS M�CHTEN WIR NOCH RICHARD STALLMAN UND LINUS
; TORVALDS F�R DIE ENTWICKLUNGSUMGEBUNG DANKEN. WUSSTET IHR �BRIGENS, DASS
; LINUS SEINE RECHNERKARRI�RE AUF DEM VC-20 ANGEFANGEN HAT?
;;;
...
; The 5th scrolltext.
;;;
; DET VAR DET. NU ER DET TID TIL HILSNER. VORES HILSNER G�R TIL ALLE
...
; MED AT M�LE SK�RMST�RRELSEN AF EN 6560. VI SENDER OGS� EN HILSEN TIL
...
; FOR UDVIKLINGSMILJ�ET BRUGT TIL AT REALISERE DEMOEN. NU VI ER VED
; DET, VIDSTE DU FORRESTEN, AT LINUS BEGYNDTE SIN COMPUTERKARRIERE P�
; VIC-20'EN?
;;;
...
;;;
#if JONAS
; CREDITS FOR THIS PART: * CODE: MARKO M�KEL� * MUSIC: JONAS HULT�N.
; CHARACTER SET: ANDERS CARLSSON AND
#else
; CREDITS FOR THIS PART: * CODE: MARKO M�KEL� * MUSIC: ANDERS CARLSSON
; * MUSIC ROUTINE: ASGER ALSTRUP. CHARACTER SET: ANDERS CARLSSON AND
#endif
; MARKO M�KEL� *** CREDITS FOR THE WHOLE DEMO: MOST PARTS BY MARKO
; M�KEL� AND MOST MUSIC BY ANDERS CARLSSON. * THE VECTOR ROUTINES WERE
...
; BERGSTR�M, AND THE MUSIC FOR THEM WAS BROUGHT TO YOU BY JONAS
; HULT�N. * IRQ-LOADER, RASTER ROUTINES, LINKING, CODE ADAPTATION AND
; NTSC FIXING BY MARKO M�KEL�. * PUBLIC RELATIONS BY JENS SCH�NFELD. *
